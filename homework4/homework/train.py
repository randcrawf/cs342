...
def train(args):
    ...
    train_data = load_detection_data('dense_data/train', transform=dense_transforms.Compose([dense_transforms.ColorJitter(0.3, 0.3, 0.3, 0.3), dense_transforms.RandomHorizontalFlip(), dense_transforms.Normalize(mean=[0.485, 0.456, 0.406], std=[0.229, 0.224, 0.225]), dense_transforms.ToTensor(), dense_transforms.ToHeatmap()]))
